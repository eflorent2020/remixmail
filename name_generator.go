...
// basically taken from docker name generator at :
// https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
// with duplicate check against ours datastores added
...
func GetFreeName(ctx context.Context) (string, error) {
	...
	return "!", errors.New("unable to generate a name")
}
